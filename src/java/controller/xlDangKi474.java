...
public class xlDangKi474 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nguoiDungDao.ktraEmailTonTai(email)) {
            ...
            getServletContext().getRequestDispatcher("/view/khachhang/gdDangKi474.jsp").forward(request, response);
        }
        
        KhachHangDao474 khachHangDao = new KhachHangDao474();
        KhachHang474 khachHang = new KhachHang474(email, ten, matKhau);
        if(!khachHangDao.addKhackHang(khachHang)) {
...
//        out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/view/khachhang/gdDangKi474.jsp").forward(request, response);
    }
