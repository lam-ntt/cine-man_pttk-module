<%-- 
    Document   : gdDangNhap474
    Created on : Nov 18, 2024, 3:45:24 PM
    Author     : nguye
--%>
...
<html>
    ...
    <body>
        ...
        <div class="section login" style="width: 45em; height: 75vh; display: flex; align-items: center; justify-content: center; margin: auto;">
            <form action="xlDangNhap474" method="post" style="width: 100%">
                <h1>Đăng nhập</h1>
                <hr>
                <div class="mb-3">
                ...
                <div class="md-3">
                    ...
                    <input type="password" id="matKhau" name="matKhau" class="form-control" aria-describedby="passwordHelpBlock" required>
                </div>
